...
$table = "<table class='table table-hover' id='users-table' style='margin: 10px auto; width:100%;color:white;border-bottom: 1px solid #2a284f;background-color:transparent;border-top-left-radius:20px;border-top-right-radius:20px'>
              <thead class='table' style='color:white;background: linear-gradient(45deg, #211F44, #302E56)!important;border-bottom:1px solid #2a284f'>
                <th>User</th>
                <th>Status</th>
                <th>Chat</th>
              </thead>";
